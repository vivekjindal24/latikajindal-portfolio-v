...
export const metadata: Metadata = {
  title: "Blockchain Architecture Course Materials",
  description: "Blockchain Architecture course materials and unit-wise PPTX presentations",
};
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50 backdrop-blur-sm bg-white/95">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center min-h-16 gap-4">
            <Link href="/courses/blockchain" className="text-xl font-bold text-gray-900">
              Blockchain Architecture Course
            </Link>
            <nav className="flex items-center gap-6">
              <Link href="/courses/blockchain" className="text-gray-600 hover:text-gray-900 text-sm font-medium transition-colors">
                Home
              </Link>
